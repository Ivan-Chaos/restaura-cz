...
- **FR-012**: All photography and video MUST be sourced from Pexels under its licence, downloaded and stored with the project (not hot-linked), with the photographer/videographer and source recorded, and each image MUST have a meaningful localized description. Photographs MUST depict real restaurant/food settings consistent with a premium establishment (no stock-looking clip art).
...
- Pexels photographs and videos are downloaded and shipped with the project (not hot-linked) with photographer attribution recorded in the repository; the Pexels licence does not require on-page attribution. Where video assets are ultimately hosted is deferred (owner decision, 2026-08-29); for now they live with the project under a size budget.
